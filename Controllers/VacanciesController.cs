...
namespace WebAppMvc.Controllers
{
    public class VacanciesController : Controller
    {
        ...
        public VacanciesController(WebAppMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,PublishedDate,Description,Salary")] Vacancy vacancy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,PublishedDate,Description,Salary")] Vacancy vacancy)
        {
            if (id != vacancy.Id)
            {
                return NotFound();
